...
const ScriptManageService = {
  ...
  async addScript(data = {}) {
    const url = '/opsScriptManage/page';
  ...
  async editScript(data = {}) {
    const url = '/opsScriptManage/update';
  ...
  async deleteScript(data = {}) {
    const url = '/opsScriptManage/delete';
  ...
  async queryScript(data = {}) {
    const url = '/opsScriptManage/detail';
    return httpGet(url, data);
  },
  /**
   * @name 上传文件
  ...
  async uploadFiles(data = {}) {
    const url = '/opsScriptManage/upload';
  ...
  async queryScriptTagList(data = {}) {
    const url = '/opsScriptManage/getScriptType';
    return httpGet(url, data);
  },
  /**
   * @name 新增脚本标签
  ...
  async addScriptTags(data = {}) {
    const url = '/opsScriptManage/viewFile';
    return httpGet(url, data);
  },
  /**
   * @name 下载脚本文件
  ...
  async downloadScript(data = {}) {
    const url = '/opsScriptManage/editFile';
    return httpPost(url, data);
  },
  /**
   * @name 下载单个文件
  ...
  async queryScriptCode(data = {}) {
    const url = '/opsScriptManage/getExcutionResult';
    return httpGet(url, data);
  },
  /**
   * @name 获取插件列表
  ...
  async resetVersion(data = {}) {
    const url = '/opsScriptManage/execute';
    return httpPost(url, data);
  },
  /**
   * @name 获取JMX脚本
  ...
  async uploadAttachments(data = {}) {
    const url = '/opsScriptManage/attachment/upload';
    return httpPost(url, data);
  },
  /**
   * @name 开始调试
  ...
  async startDebug(data = {}) {
    const url = '/opsScriptManage/getExcutionLog';
    return httpGet(url, data);
  },
  /**
   * @name 获取调试脚本历史记录列表
