...
import { Icon, Tooltip, Collapse } from 'antd';
...
const TestRunDataConfigConfig = (
  state,
  setState,
  props
): FormCardMultipleDataSourceBean => {
  /** @name 漏数验证设置 */
  const getTestRunDataConfigFormData = (): FormDataType[] => {
  ...
  return {
    ...
    rowNum: 1,
    span: 20,
    formData: getTestRunDataConfigFormData()
  };
};

export default TestRunDataConfigConfig;
